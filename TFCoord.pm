...
sub new
{
	...
	#my $tf_file_name = "../hap235_motifs_yeastsaccer3.bed";
	#my $tf_file_name = "../mcm1_motifs_yeastsaccer3.bed";
	#my $tf_file_name = "../hap235_motifs_yeastsaccer3_ORF100bp.bed";
	#my $tf_file_name = "../WT_0h_allreps_dipy_bk_inbetween_Pugh_100bp_Hap235_sort_uniq_rev_1bp.bed";
	#my $tf_file_name = "../Hap235_RF_targets.bed";	
	#my $tf_file_name = "../Hap235comb_CX_proc_sort.bed";
	my $tf_file_name = "../hap235variant_motifs_yeastsaccer3.bed";
	...
	while( my $line = <GENE> )
	{
		...
		push @{$tf{$fields[0]}}, [$fields[1], $fields[2], $fields[5]];
		#print STDERR "$line\n";
	}
